...
contract IntegrationTest is Test {
    ...
    function setUp() external {
        // vm.createSelectFork("https://eth-mainnet.g.alchemy.com/v2/7uuQCPu-lHbOrA_pkmzXWvDfx-aj6DxH", 17_328_107); //ethereum
    ...
    function testScenario() external {
        ...
        uint256 stBalance = IERC20(WSTETH_ADDR).balanceOf(address(dummyImpProxy));
        IERC20(WSTETH_ADDR).approve(address(dummyImpProxy), stAmount);
