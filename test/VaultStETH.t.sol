...
contract VaultStETHTest is DSTest {
    ...
    function setUp() external {
        ...
        // TransparentUpgradeableProxy strategyProxy = TransparentUpgradeableProxy(
        //     payable(0x3fD49A8F37E2349A29EA701b56F10f03B08F1532)
        // );
        // adminProxy = AdminModule(address(strategyProxy));
        // vm.prank(0x8FA9aa69a6e94c1cd49FbF214C833B2911D02553);
        // console.log("vault", address(adminProxy.owner()));
